#ifndef COMPONENT_ZDT_MOTOR_H
#define COMPONENT_ZDT_MOTOR_H
#include "can.h"
#include "stdint.h"

/*************** 宏定义 *****************/
typedef struct {
	volatile CAN_RxHeaderTypeDef CAN_RxMsg;
	volatile uint8_t rxData[32];
	
	volatile CAN_TxHeaderTypeDef CAN_TxMsg;
...
/*************** 函数声明 *****************/
void can_init(void); 
void CAN_RXCALLBACK(void); //在手动can的中断中调用
